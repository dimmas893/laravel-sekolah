            ...
            <div class="section-body">
                @if ($role === 1)
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('pilihjenjangujian') }}">
                                <div class="card shadow card-primary">
                                    <div class="card-body">
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="100px" src="/icon/ujian.png"
                                                                alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="100px"
                                                                src="/icon/tanggalseleksi.png" alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <img class="d-block" width="80px"
                                                                src="/icon/kategoribuku.png" alt="First slide">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
