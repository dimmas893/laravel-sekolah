...
<div id="tabs">
    <div class="modal fade" id="editTUModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
    ...
    <div class="modal fade" id="pdfguru" tabindex="-1" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"><input type="button" class="text-danger" id="btnPreview" value="Preview PDF" onclick="LoadPdfFromUrl('{{ asset('file_tugas/' . $tugas->tugas->file_tugas) }}')" /></h5>
                </div>
                <div class="modal-body">
    ...
    <hr />
    <div class="modal fade" id="pdfsiswa" tabindex="-1" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <iframe id="if1" width="100%" height="900" style="visibility:visible" src="{{ asset('file_tugas/' . $tugas->file_upload) }}"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ route('tugassiswaview') }}" onclick="event.preventDefault();
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-xl-12 col-xxl-12">
                        <div class="card shadow card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class=""> <i class="ion-ios-paper h5"></i>
                                    ...
                                    <a href="#" class="text-danger mx-1" data-toggle="modal" data-target="#pdfguru">pdf</a> - Kesempatan ({{ $tugas->kesempatan }})
                                ...
                                <div>
                                    ...
                                    <a href="#" id="{{ $tugas->id }}" class="btn btn-primary mx-1 editIcon" data-toggle="modal" data-target="#editTUModal">Upload jawaban</a>
                                    @endif
                                </div>
                                {{-- <div class="text-right">{{ $tugas->jadwal->id }}
                            </div> --}}
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            PDF jawaban anda</a> --}}
                            <a href="#" class="text-danger mx-1" data-toggle="modal" data-target="#pdfsiswa">Preview jawaban</a>
                            @endif
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function loadsiswa(url) {
        ...
        pdfjsLib.getDocument(url).promise.then(function(pdfDoc_) {
            ...
            //Loop and render all pages.
            for (var i = 1; i <= pdfDoc.numPages; i++) {
                RenderPagesiswa(pdf_container, i);
            }
        });
    };

    function RenderPagesiswa(pdf_container, num) {
        pdfDoc.getPage(num).then(function(page) {
            //Create Canvas element and append to the Container DIV.
            var canvas = document.createElement('canvas');
            canvas.id = 'pdf-' + num;
