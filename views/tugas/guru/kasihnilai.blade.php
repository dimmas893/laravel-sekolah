                ...
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a
                                href="{{ route('menutugasshowkelaslihatdetaillihat', $siswa->kelas) }}">Mata pelajaran</a>
                        </div>
                        <div class="breadcrumb-item active"><a
                                href="/menu/tugas/kelas-detail/{{ $siswa->kelas }}/{{ $tugas->mata_pelajaran_id }}">Kumpulan
                                tugas</a>
                        </div>
                        <div class="breadcrumb-item active"><a href="{{ route('tugassiswaall', $tugas->id) }}">Detail tugas
                                {{ $tugas->nama }}</a>
                        </div>
                        <div class="breadcrumb-item">Detail tugas {{ $tugas->nama }} {{ $siswa->nama_siswa }}</div>
                    </div>
                </div>
                <div class="">
