...
@section('content')
    <form method="get" id="seleksi-pemberiannilai_tk" action="{{ route('seleksi-pemberiannilai') }}" style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="4">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="seleksi-pemberiannilai_sd" action="{{ route('seleksi-pemberiannilai') }}"
        style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="1">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="seleksi-pemberiannilai_smp" action="{{ route('seleksi-pemberiannilai') }}"
        style="display:none;">
        @csrf
        <input type="hidden" name="jenjang_pendidikan_id" value="2">
        <input type="submit" class="btn btn-primary" value="Masuk">
    </form>
    <form method="get" id="seleksi-pemberiannilai_sma" action="{{ route('seleksi-pemberiannilai') }}"
        style="display:none;">
        @csrf
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-lg-3">
                        <a href="{{ route('seleksi-pemberiannilai') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('seleksi-pemberiannilai_tk').submit();">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('seleksi-pemberiannilai') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('seleksi-pemberiannilai_sd').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('seleksi-pemberiannilai') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('seleksi-pemberiannilai_smp').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('seleksi-pemberiannilai') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('seleksi-pemberiannilai_sma').submit();">
                            <div class="card shadow card-primary">
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
