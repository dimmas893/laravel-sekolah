                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <select name="agama" class="form-control">
                                                @if ($siswa->agama)
                                                    ...
                                                    <option value="{{ $siswa->agama }}" selected disabled>
                                                        {{ $siswa->agama }}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <select name="agama_bapak" class="form-control">
                                                    @if ($wali->agama_bapak)
                                                        <option value="">---Pilih Agama---</option>
                                                        <option value="{{ $wali->agama_bapak }}" selected disabled>
                                                            {{ $wali->agama_bapak }}</option>
                                                        <option value="Kristen">Kristen</option>
                                                    @else
                                                        <option value="" selected disabled>---Pilih Agama---</option>
                                                        <option value="islam">Islam</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <select name="agama_ibu" class="form-control">
                                                    @if ($wali->agama_ibu)
                                                        <option value="">---Pilih Agama---</option>
                                                        <option value="{{ $wali->agama_ibu }}" selected disabled>
                                                            {{ $wali->agama_ibu }}</option>
                                                        <option value="Kristen">Kristen</option>
                                                    @else
                                                        <option value="" selected disabled>---Pilih Agama---</option>
                                                        <option value="islam">Islam</option>
