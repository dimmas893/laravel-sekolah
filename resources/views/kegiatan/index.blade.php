                    ...
                    success: function(response) {
                        ...
                        $.each(response.gambar, function(index, value) {
                            $('gambarkegiatan').append(
                                ...
                                <input class="form-check-input" name="hapusgambar[]" type="checkbox" value="${value.id}">`
                            );
                        });
                        $.each(response.lampiran, function(index, value) {
                            $('gambarkegiatanlampiran').append(
                                ...
                                <input class="form-check-input" name="hapuslampiran[]" type="checkbox" value="${value.id}">
                                     </div>
                                </div> `
                            );
                        });
