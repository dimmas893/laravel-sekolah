            ...
            <div class="section-header">
                ...
                @if ($guru)
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a href="{{ route('menutugasshow') }}">Tugas</a></div>
                        <div class="breadcrumb-item active"> <a href="{{ route('pilihmatapelajaran') }}"
                                onclick="event.preventDefault();document.getElementById('pilihmatapelajaran_id').submit();">Buat
                                tugas
                            </a></div>
                        ...
                        <div class="breadcrumb-item">Buat Tugas</div>
                    </div>
                @else
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="{{ route('menu') }}">Menu</a></div>
                                ...
                                <div class="col-12">
                                    <div class="card shadow card-success">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            -
                                            {{ \App\Models\Mata_Pelajaran::where('tahun_ajaran_id', $tahun)->where('id', $jadwal->mata_pelajaran_id)->first()->name }}
                                            -
                                            {{ \App\Models\Guru::where('id', $jadwal->guru_id)->first()->name }} -
                                            {{ \App\Models\Kelas::with('kelas')->where('id', $jadwal->kelas_id)->first()->kelas->name }}
                                            <div>
                                                Total tugas {{ $tugas }} <a class="btn btn-primary"
                                                    href="/menu/tugas/kelas-detail/admin/{{ $jadwal->kelas_id }}/{{ $jadwal->mata_pelajaran_id }}">Lihat</a>
                                            </div>
                                        </div>
                                        <div class="card-body">
