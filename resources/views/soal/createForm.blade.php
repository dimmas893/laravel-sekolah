                                ...
                                @for ($i = 0; $i < $form; $i++)
                                    ...
                                    <div>
                                        <label for=""><b class="badge badge-success">Soal
                                                {{ $i + 1 }}</b></label>
                                        <textarea name="soal[]" class="form-control summernote" placeholder="Masukan soal" required></textarea>
                                    </div>
                                    <div>
                                        <label for="">Jawaban a</label>
                                        <textarea name="jawaban_a[]" class="form-control summernote" placeholder="Masukan jawaban a" required></textarea>
                                    </div>
                                    <div>
                                        <label for="">Jawaban b</label>
                                        <textarea name="jawaban_b[]" class="form-control summernote" placeholder="Masukan jawaban b" required></textarea>
                                    </div>
                                    <div>
                                        <label for="">Jawaban c</label>
                                        <textarea name="jawaban_c[]" class="form-control summernote" placeholder="Masukan jawaban c" required></textarea>
                                    </div>
                                    <div>
                                        <label for="">Jawaban d</label>
                                        <textarea name="jawaban_d[]" class="form-control summernote" placeholder="Masukan jawaban d" required></textarea>
                                    </div>
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <label for=""></label>
                                            <select class="form-control form-control-sm" name="kunci_jawaban[]" required>
