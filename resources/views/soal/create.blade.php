        ...
        $(function() {
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $("#soal").summernote('code', response.soal);
                        $("#jawaban_a").summernote('code', response.jawaban_a);
                        $("#jawaban_b").summernote('code', response.jawaban_b);
                        $("#jawaban_c").summernote('code', response.jawaban_c);
                        $("#jawaban_d").summernote('code', response.jawaban_d);
