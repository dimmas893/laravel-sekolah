                ...
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        @elseif($kelas->kelas->jenjang_pendidikan_id === 3)
                            ...
                            <div class="breadcrumb-item">Jadwal kelas
                                {{ $kelas->kelas->name }} {{ $kelas->jurusan }}</div>
                        @endif
                    </div>
                </div>
        ...
        $(function() {
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        var str = response.jam_masuk;
                        var jam_masuk = str.substring(0, 5)
                        var str = response.jam_keluar;
                        var jam_keluar = str.substring(0, 5)
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    title: 'Upsssss?',
                    text: "Menghapus data ini akan menyebabkan masalah di beberapa tempat contohnya di data absen, data tugas dll !",
                    icon: 'info',
                })
                // .then((result) => {
