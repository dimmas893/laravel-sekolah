                        ...
                        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="my-2">
                                    ...
                                    <input type="number" name="kuota" placeholder="Masukan Kuota" class="form-control"
                                        required>
                                </div>
                                <div class="my-2">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="my-2">
                                    <label for="name">Gelombang</label>
                                    <input type="number" name="gelombang" id="gelombang" placeholder="Masukan Gelombang"
                                        class="form-control" required>
                                </div>
                                <div class="my-2">
                                    <label for="name">Tahun Ajaran</label>
                                ...
                                <div class="my-2">
                                    <label for="name">Kuota</label>
                                    <input type="number" name="kuota" id="kuota" placeholder="Masukan Kuota"
                                        class="form-control" required>
                                </div>
                                <div class="my-2">
                                    <label for="name">Jenjang</label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200) {
                            ...
                            Swal.fire(
                                'Opss!',
                                'Tanggal seleksi yang aktif di 1 jenjang, 1 tahun ajaran dan 1 tanggal hanya bisa 1!',
                                'info'
                            )
                        };
                    }
