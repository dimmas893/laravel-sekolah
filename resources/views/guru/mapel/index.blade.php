        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                @foreach ($mata_pelajaran as $item)
                    @php
                        $kelas = \App\Models\Jadwal::with('kelasget')
                    ...
                    <div class="card">
                        <div class="card-header bg-secondary">
                            <h4>{{ \App\Models\Mata_Pelajaran::where('tahun_ajaran_id', $tahun)->where('id', $item->mata_pelajaran_id)->first()->name }}
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="card card-primary">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                {{ $kel->kelasget->kelas->name }} @if ($kel->kelasget->jurusan != null)
                                                    - {{ $kel->kelasget->jurusan }}
                                                @endif
