                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="/menu/tugas/kelas-detail/{{ $kelas_id }}/{{ $item->mata_pelajaran_id }}"
                                                class="btn btn-primary">Semua Tugas</a>
                                        </div>
                                    </div>
                                    <div class="card-body">

                                        <div>Expired = {{ $expired }} <a
                                                href="/menu/tugas/kelas-detail/expired/{{ $kelas_id }}/{{ $item->mata_pelajaran_id }}"
                                                class="btn btn-primary">Semua Masuk</a></div>
                                        <div>Berlangsung = {{ $berlangsung }}<a
                                                href="/menu/tugas/kelas-detail/berlangsung/{{ $kelas_id }}/{{ $item->mata_pelajaran_id }}"
                                                class="btn btn-primary">Semua Masuk</a></div>
                                    </div>
                                </div>
                            </div>
