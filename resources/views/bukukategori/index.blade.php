                ...
                <div class="modal-content">
                    ...
                    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                <label for="image">Select Gambar</label>
                                <input type="file" id="emp_image" name="gambar" class="form-control">
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Kategori Buku</h3>
                                {{-- @if (\App\Models\Kategori Buku::count() === 0) --}}
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Kategori Buku</button>
                                {{-- @endif --}}
                            </div>
                            <div>
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#image").html(
                            `<img src="/gambarkategori/${response.gambar}" width="100" class="img-fluid img-thumbnail">`
                        );
                        $("#emp_image").val(response.gambar);
                        $("#id").val(response.id);
                    }
                });
            });
