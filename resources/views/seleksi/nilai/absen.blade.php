        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ route('seleksi-jenjang-absen') }}">Jenjang</a>
                    </div>
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('pemberiannilaiabsen') }}" method="get">
                            @csrf
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="ml-3">
                                                            <a class="btn btn-primary"
                                                                href="/tanggalseleksi-pilih-tingkatan/{{ $item->jenjang }}/{{ $item->id }}">Masuk</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
