    ...
    <div class="main-content">
                    ...
                    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                ...
                                <input type="file" id="emp_image" name="file" class="form-control">
        ...
        <section class="section">
            <div class="section-header">
                <h1>Halaman Bahan Ajar</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('menu') }}">Menu</a></div>
                    <div class="breadcrumb-item active"><a href="{{ route('manage') }}">Manage</a></div>
                    <div class="breadcrumb-item active"><a href="{{ route('mata_pelajaran') }}">Mata pelajaran</a></div>
                    <div class="breadcrumb-item">Bahan Ajar</div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h3 class="text-light">Tabel Bahan Ajar</h3>
                                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                                        class="bi-plus-circle me-2"></i>Tambah Bahan Ajar</button>
                            </div>
                            <div>
...
@section('js')
    <script>
        $(function() {
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#image").html(
                            `<a href="/bahanajar/${response.file}" target="_blank">Open File</a>`
                        );
                        $("#emp_image").val(response.file);
                        $("#id").val(response.id);
                    }
                });
            });
            ...
            function TU_all() {
                $.ajax({
                    url: '{{ route('bahan-ajar-all', $mata_pelajaran_id) }}',
                    method: 'get',
                    success: function(response) {
