    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Halaman Detail Siswa Pindahan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"> <a href="{{ route('siswa-pindahan-view') }}"
                            onclick="event.preventDefault();
                                    document.getElementById('siswa-pindahan-view_tk').submit();">Back</a>
                    </div>
                </div>
            </div>
            ...
            @if ($pendaftaran->hasil != null)
                Sudah di tinjau
            @else
                <form action="{{ route('konfirmasi-diterima-siswa-pindahanpost') }}" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <input type="number" disabled
                                                    value="{{ $pendaftaran->penghasilan_bapak }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <input type="number" disabled
                                                    value="{{ $pendaftaran->penghasilan_ibu }}"
                                                    placeholder="Masukan Penghasilan" class="form-control" />
                                            </div>
                                            <div class="form-group col-md-6 col-12">
                                                <label>Agama</label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12 col-12">
                                                <select name="hasil" class="form-control" required>
                                                    <option value="" disabled selected>---Pilih Kofirmasi---</option>
                                                    <option value="lulus">Lulus</option>
                                                    <option value="tidaklulus">Tidak Lulus</option>
                                                </select>
                                                <p style="color:red">*Konfirmasi Kelulusan</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <img alt=""
                                                    src="{{ asset('bukti_bayar/' . $pendaftaran->bukti_bayar) }}"
                                                    class="" width="300" data-toggle="tooltip"
                                                    title="bukti bayar {{ $pendaftaran->nama_siswa }}">
                                                <p style="color:red;">*Bukti bayar</p>
                                            </div>
                                        </div>
                                    </div>
