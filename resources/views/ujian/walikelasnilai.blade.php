        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ route('ujianwalikelas') }}">Ujian</a></div>
                    <div class="breadcrumb-item">Detail nilai siswa</div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            function TU_all() {
                $.ajax({
                    url: '{{ route('allwalkelasnilaiajax', $id) }}',
                    method: 'get',
