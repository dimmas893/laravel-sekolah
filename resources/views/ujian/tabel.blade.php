    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    title: 'Upsssss?',
                    text: "Menghapus data ini akan menyebabkan masalah di beberapa tempat contohnya di data soal, data nilai dll !",
                    icon: 'info',
                })
                // .then((result) => {
            ...
            function TU_all() {
                $.ajax({
                    url: '/ujian/all/{{ $mata_pelajaran->id }}/{{ $tingkatan_id }}/{{ $jenjang_pendidikan_id }}',
                    method: 'get',
                    success: function(response) {
